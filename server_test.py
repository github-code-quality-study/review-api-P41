...
class ReviewAnalyzerServerTest(unittest.TestCase):
    ...
    def test_post_review(self):
        ...
        response = self.testapp.post("/", params=json.dumps(review), headers={'Content-Type': 'application/json'})
    ...
    def test_post_review_with_missing_review_body(self):
        ...
        response = self.testapp.post("/", params=json.dumps(review), headers={'Content-Type': 'application/json'}, expect_errors=True)
